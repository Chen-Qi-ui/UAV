...
/* 如果 core_cm4.h 没定义，手动定义 DWT 结构体 */
#ifndef DWT_BASE
#define DWT_BASE             (SCS_BASE +  0x1000UL)   /* DWT 基地址 */
#define DWT                  ((DWT_Type       *)     DWT_BASE      ) 

typedef struct
{
  __IO uint32_t CTRL;                  /*!< Offset: 0x000 (R/W)  控制寄存器 */
  __IO uint32_t CYCCNT;                /*!< Offset: 0x004 (R/W)  核心周期计数器 (我们需要的) */
  __IO uint32_t CPICNT;                /*!< Offset: 0x008 (R/W)  CPI 计数寄存器 */
  __IO uint32_t EXCCNT;                /*!< Offset: 0x00C (R/W)  异常开销计数寄存器 */
  __IO uint32_t SLEEPCNT;              /*!< Offset: 0x010 (R/W)  睡眠计数寄存器 */
  __IO uint32_t LSUCNT;                /*!< Offset: 0x014 (R/W)  LSU 计数寄存器 */
  __IO uint32_t FOLDCNT;               /*!< Offset: 0x018 (R/W)  折叠指令计数寄存器 */
  __I  uint32_t PCSR;                  /*!< Offset: 0x01C (R/ )  程序计数器采样寄存器 */
  __IO uint32_t COMP[4];               /*!< Offset: 0x020 (R/W)  比较器寄存器 */
} DWT_Type;

/* 顺便检查一下这个宏在你的文件里有没有，启用 DWT 必须用到它 */
